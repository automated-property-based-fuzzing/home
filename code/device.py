...
class Device(object):
    ...
    def click(self,view):
        try:
            if view.description !="" and view.description !="#any#"and view.resourceId !="" and view.resourceId !="#any#":
                self.use(resourceId=view.resourceId,description=view.description).click()
            ...
            elif view.resourceId !="" and view.resourceId !="#any#" and view.instance!="" and view.instance!="#any#":
            ...
            elif view.className !="" and view.className !="#any#" and view.instance!="" and view.instance!="#any#":
    ...
    def clear_app(self,app):
        if app.package_name != "com.tencent.mm":
    ...
    def longclick(self,view):
        try:
            if view.description !="" and view.description !="#any#"and view.resourceId !="" and view.resourceId !="#any#":
                self.use(resourceId=view.resourceId,description=view.description).long_click()
            elif view.description !="" and view.description !="#any#":
            ...
            if view.x!=-1 and view.y!=-1:
                ...
                self.use(className=view.className).long_click()
    ...
    def edit(self,view,text):
        try:
            if view.description !="" and view.description !="#any#"and view.resourceId !="" and view.resourceId !="#any#":
                self.use(resourceId=view.resourceId,description=view.description).set_text(text)
            elif view.description !="" and view.description !="#any#":
                self.use(description=view.description).set_text(text)
                return "self.use(description="+view.description+").set_text("+text+")"
            elif view.resourceId !="" and view.resourceId !="#any#" and view.instance!="" and view.instance!="#any#":
            ...
            elif view.text !="" and view.text !="#any#" and view.className !="" and view.className !="#any#":
                self.use(text=view.text,className=view.className).set_text(text)
            else:
                self.use(className=view.className,packageName=view.package).set_text(text)
                return "self.use(className="+view.className+",packageName="+view.packageName+").set_text("+text+")"
        except:
            self.use(className=view.className).set_text(text)
            return "self.use(className="+view.className+").set_text("+text+")"
